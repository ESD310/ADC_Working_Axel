...
REM
REM Generated by Vivado on Fri Nov 01 11:27:49 +0100 2024
...
echo "xvlog --incr --relax -prj ADC1_wrapper_vlog.prj"
call xvlog  --incr --relax -prj ADC1_wrapper_vlog.prj -log xvlog.log
