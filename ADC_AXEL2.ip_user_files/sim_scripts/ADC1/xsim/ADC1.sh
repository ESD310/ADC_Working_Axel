...
#
# Script generated by Vivado on Fri Nov 01 11:27:36 +0100 2024
...
#
# Usage        : ADC1.sh
#                ADC1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ADC1.sh [-reset_run]
#                ADC1.sh [-reset_log]
#                ADC1.sh [-help]
#
...
# script info
echo -e "ADC1.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ADC1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ADC1 xil_defaultlib.ADC1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ADC1 -key {Behavioral:sim_1:Functional:ADC1} -tclbatch cmd.tcl -protoinst "protoinst_files/ADC1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ADC1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ADC1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ADC1.sh [-help]\n\
Usage: ADC1.sh [-step]\n\
Usage: ADC1.sh [-lib_map_path]\n\
Usage: ADC1.sh [-reset_run]\n\
Usage: ADC1.sh [-reset_log]\n\
Usage: ADC1.sh [-keep_index]\n\
Usage: ADC1.sh [-noclean_files]\n\n\
